...
wget "http://api.github.com/repos/bpmn-miwg/bpmn-miwg-test-suite/issues" --output-document=issues.json
wget "http://api.github.com/repos/bpmn-miwg/bpmn-miwg-test-suite/issues?state=closed" --output-document=issues-closed.json
