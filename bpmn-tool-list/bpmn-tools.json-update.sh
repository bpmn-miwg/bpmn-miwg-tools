...
wget "https://api.github.com/repos/bpmn-miwg/bpmn-miwg-test-suite/issues?state=open"   --output-document=issues-open.json
wget "https://api.github.com/repos/bpmn-miwg/bpmn-miwg-test-suite/issues?state=closed" --output-document=issues-closed.json
